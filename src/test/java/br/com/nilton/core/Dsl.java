...
public class Dsl {
     ...
     */
	public void clicaBotaoDaTabela(String colunaNome, String buscaNome, String colunaBotao, String nomeTabela) {
        ...
        WebElement botao = tabela.findElement(By.xpath("./tbody/tr["+idLinhaRegistro+"]/td["+idColunaBotao+"]//input"));
    ...
    private WebElement obtemTabela(String nomeTabela) {
